...
const char* ei_classifier_inferencing_categories[] = { "BarbellRow", "BicepCurl", "NoExercice", "RomanianDeadlift", "Squat" };
...
const ei_learning_block_config_anomaly_kmeans_t ei_learning_block_config_7 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_7_inputs[1] = { 2 };
...
const ei_impulse_t impulse_628922_0 = {
    .project_id = 628922,
    .project_owner = "PARIS POLLEZEL",
    .project_name = "Exercice_clasifier",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_628922_0 = ei_impulse_handle_t( &impulse_628922_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_628922_0;
